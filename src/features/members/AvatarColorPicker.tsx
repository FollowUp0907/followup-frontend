    ...
    <div ref={rootRef} className="relative shrink-0">
      ...
      {open && (
        <div
          ...
          className="absolute left-0 top-[calc(100%+6px)] z-30 w-[188px] animate-scale-in origin-top rounded-md border border-hairline bg-canvas p-sm shadow-card"
        >
          ...
          <p className="mt-xs text-[11px] font-normal leading-snug text-muted-soft">
            이 브라우저에만 저장됩니다.
          </p>
        </div>
      )}
